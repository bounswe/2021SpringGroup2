    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if (!badgeList.isNullOrEmpty()) {
            ...
            for (badgeName in badgeList) {
                ReboundAPI.create().getBadgeByName(token, badgeName)
                        ...
                        override fun onResponse(
                            ...
                            if (response.isSuccessful) {
                                if (response.body()?.name == "MVP") {
                                    ...
                                    val decodedImage1 = BitmapFactory.decodeByteArray(
                                        imageBytes1,
                                        0,
                                        imageBytes1.size
                                    )
                                    ...
                                    val decodedImage2 = BitmapFactory.decodeByteArray(
                                        imageBytes2,
                                        0,
                                        imageBytes2.size
                                    )
                                    ...
                                    val decodedImage3 = BitmapFactory.decodeByteArray(
                                        imageBytes3,
                                        0,
                                        imageBytes3.size
                                    )
                                    ...
                                    val decodedImage4 = BitmapFactory.decodeByteArray(
                                        imageBytes4,
                                        0,
                                        imageBytes4.size
                                    )
                                    ...
                                    val decodedImage5 = BitmapFactory.decodeByteArray(
                                        imageBytes5,
                                        0,
                                        imageBytes5.size
                                    )
                                    ...
                                    val decodedImage6 = BitmapFactory.decodeByteArray(
                                        imageBytes6,
                                        0,
                                        imageBytes6.size
                                    )
