...
class FragmentPlayers : Fragment(), RecyclerAdapterUser.OnItemClickListener {
    ...
    var next = false
    private lateinit var playersFragListener: FragmentPlayersListener

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        playersFragListener = requireActivity() as FragmentPlayersListener
        ...
        for(i in 0 until players.size){
            ReboundAPI.create().getUser(token,players[i].toString()).enqueue(object : Callback<UserResponse>{
...
//        TODO("Not yet implemented")
    ...
    interface FragmentPlayersListener {
        //        TODO("Not yet implemented")
    }
    ...
    companion object {
        ...
        fun newInstance(token: String, username: String, players : ArrayList<Int>) = FragmentPlayers().also {
