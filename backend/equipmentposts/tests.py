...
class EquipmentPostSearchTests(APITestCase):
    def setUp(self):
        ...
        self.event_01 = EquipmentPost.objects.create(owner=self.user, title='Football for sale',
        ...
        self.event_03 = EquipmentPost.objects.create(owner=self.user, title='NBA ball or something idk',
        ...
        self.event_04 = EquipmentPost.objects.create(owner=self.user, title='Vintage Nike mercurial football cleats',
        ...
        self.basketball_games = EquipmentSerializer(EquipmentPost.objects.filter(sport="Basketball"), many=True).data

        self.football_games = EquipmentSerializer(EquipmentPost.objects.filter(sport="Football"), many=True).data

        self.in_turkey_games = EquipmentSerializer(EquipmentPost.objects.filter(
            Q(location="levent") | Q(location="etiler")), many=True).data

        self.date_inside_2022_games = self.basketball_games

        self.games_created_by_user = EquipmentSerializer(EquipmentPost.objects.all(), many=True).data
